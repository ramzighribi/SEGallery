...
const useStyles = makeStyles({
  card: {
    ...
    ...shorthands.border('1.5px', 'solid', 'rgba(99, 102, 241, 0.08)'),
    ...
    ':hover': {
      ...
      boxShadow: '0 24px 64px rgba(99, 102, 241, 0.18), 0 8px 24px rgba(139, 92, 246, 0.08)',
  ...
  placeholder: {
    ...
    background: 'linear-gradient(135deg, #eef2ff 0%, #e8e0f7 50%, #ddd6fe 100%)',
  },
  placeholderContent: {
    display: 'flex',
